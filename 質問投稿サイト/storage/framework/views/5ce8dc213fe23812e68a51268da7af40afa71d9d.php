...
<form method="post" action="<?php echo e(url('/posts')); ?>">
  ...
  <a class="btn btn-warning btn-sm" href="<?php echo e(url('/home')); ?>">
                        キャンセル
                    </a>
</form>
</div>
...
<?php echo $__env->make('layout.qalayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\cdgam\Desktop\QAサイト\resources\views/posts/create.blade.php ENDPATH**/ ?>